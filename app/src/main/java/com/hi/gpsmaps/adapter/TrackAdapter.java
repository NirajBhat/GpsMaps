...
import com.hi.gpsmaps.fragment.trackfragmentpackage.DynamicTrackFragment;
import com.hi.gpsmaps.fragment.trackfragmentpackage.DynamicTrackFragmentSecond;
import com.hi.gpsmaps.interfacepackage.CallbackTabsInterface;
...
public class TrackAdapter extends FragmentPagerAdapter{
    ...
    public Fragment getItem(int position) {
        ...
        switch(position){
            case 0:
                return DynamicTrackFragment.newInstanceTrack(position,mStringArrayList.get(position));
            case 1:
                return DynamicTrackFragmentSecond.newInstanceTrackSecond(position,mStringArrayList.get(position));
            default:
                return null;
        }
    }
